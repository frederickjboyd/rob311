...
# from cursed_2 import DQNAgent as CartPoleAgent
# from cursed_3 import CartPoleAgent
# from cursed_4 import CartPoleAgent
# from cursed_5 import CartPoleAgent
        ...
        for steps in range(MAX_STEPS):
            ...
            if terminal:
                ...
                if episode_reward >= SUCCESS_REWARD:
                    win_streak += 1
                    print("reward >= SUCCESS_REWARD:", win_streak)
                else:
                    win_streak = 0
                break
